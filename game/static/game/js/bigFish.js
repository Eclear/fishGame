...
momObj.prototype.init = function(){
    ...
    for(var i = 0; i < 8; i++){
        ...
        this.bigTail[i].src = "../static/game/src/bigTail" + i + ".png";
    }
    for(var i = 0; i < 2; i++){
        this.bigEye[i] = new Image();
        this.bigEye[i].src = "../static/game/src/bigEye" + i + ".png";
    }
    for(var i = 0; i < 8; i++){
        this.bigBodyOrange[i] = new Image();
        this.bigBodyOrange[i].src = "../static/game/src/bigSwim" + i + ".png";
    }
    for(var i = 0; i < 8; i++){
        this.bigBodyBlue[i] = new Image();
        this.bigBodyBlue[i].src = "../static/game/src/bigSwimBlue" + i + ".png";
    }
}
momObj.prototype.draw = function () {
    //lerp x,y
    this.x = limitLerpDistance(mx, this.x, 0.98);
    this.y = limitLerpDistance(my, this.y, 0.98);
