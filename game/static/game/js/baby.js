...
babyObj.prototype.init = function () {
    ...
    this.angle = 0;
    this.babyEye.src = "../static/game/src/babyEye0.png";
    this.babyBody.src = "../static/game/src/babyFade0.png";
    //this.babyTail.src = "./src/babyTail0.png";
    for(var i = 0; i < 8; i++){
        this.babyTail[i] = new Image();
        this.babyTail[i].src = "../static/game/src/babyTail" + i + ".png";
    }
    for(var i = 0; i < 2; i++){
        this.babyEye[i] = new Image();
        this.babyEye[i].src = "../static/game/src/babyEye" + i + ".png";
    }
    for(var i = 0; i < 20; i++){
        this.babyBody[i] = new Image();
        this.babyBody[i].src = "../static/game/src/babyFade" + i + ".png";
    }
}
